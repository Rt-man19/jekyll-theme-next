...
![](images/zbx_install_1.png)

点击Next step

![环境检查](images/zbx_install_2.png)

如果有某项是false，则修改php.ini这个文件对应的配置项,直到全都OK,点击Next step

![数据库配置](images/zbx_install_3.png)

在Password文本框中输入zabbix数据的密码,点击Next step

![](images/zbx_install_4.png)

![确认信息](images/zbx_install_5.png)

![](images/zbx_install_6.png)
...
填写好信息之后点击Add![](images/zbx_addmtype_1.png)
...
![](images/zbx_alert_1.png)

稍等片刻后就可以收到邮件了

![](images/zbx_alert.jpg)
